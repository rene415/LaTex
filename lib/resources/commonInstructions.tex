...
\begin{itemize}
  ...
  check the version of Python with the following command: python -V
  ...
  \item The function eval is never allowed.
  ...
  \item You can also ask questions in the \#bootcamps channel in the \href{https://42-ai.slack.com}{42AI}
  ...
  project even though this work won't have to be
